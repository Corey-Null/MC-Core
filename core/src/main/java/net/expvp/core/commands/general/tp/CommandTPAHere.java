...
/**
 * Class used for handling command /tpahere
 * 
 * @author NullUser
 * @see AccountCommand
 */
public class CommandTPAHere extends AccountCommand {

	public CommandTPAHere(NullContainer container) {
		super(container, "tpahere", "core.tpahere", "/tpahere <player>", 1);
	}
	...
	public void execute(OnlinePlayerAccount account, String[] args) {
		...
		handler.initRequest(account, target, TPRequestMotion.HERE);
