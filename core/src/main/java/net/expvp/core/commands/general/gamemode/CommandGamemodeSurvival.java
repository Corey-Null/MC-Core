...
/**
 * Class used for handling command /gamemodesurvival
 * 
 * @author NullUser
 * @see NullCommand
 */
public class CommandGamemodeSurvival extends NullCommand {

	public CommandGamemodeSurvival(NullContainer container) {
		super(container, "gamemodesurvival", "core.gamemode.survival", "/gms [player]", 0, true);
	}
